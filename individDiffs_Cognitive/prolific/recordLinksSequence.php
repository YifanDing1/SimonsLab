...
try {
    ...
    // First verify the subject_code exists in metaDataCog
    $check_sql = "SELECT subject_code FROM metaDataCog WHERE subject_code = :subject_code";
    ...
    if ($check_stmt->rowCount() === 0) {
        ...
        $insert_sql = "INSERT INTO metaDataCog (subject_code, taskSequence) VALUES (:subject_code, :taskSequence)";
        ...
        $update_sql = "UPDATE metaDataCog SET taskSequence = :taskSequence WHERE subject_code = :subject_code";
