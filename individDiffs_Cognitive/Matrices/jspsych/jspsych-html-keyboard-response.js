      ...
      trial(display_element, trial) {
          ...
          const end_trial = () => {
              ...
              var trial_data = {
                  ...
                  TMB_Matrix_PracticeProblemNumSequence: [1,2,3,4],
                  TMB_Matrix_ProblemNumSequence: [7, 17, 22, 25, 27, 28, 31, 35],
                  TMB_Matrix_PracticeCorrectAnswerSequence: [3,1,3,4],
                  TMB_Matrix_CorrectAnswerSequence: [3, 4, 3, 4, 5, 4, 1, 1]
              };
